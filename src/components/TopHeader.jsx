                ...
                <div className="relative pl-3 border-l border-slate-200">
                    ...
                    >
                        ...
                        <div className="hidden sm:block text-left">
                            ...
                            <div className="text-[10px] text-slate-400 font-medium leading-none mt-0.5">Admin</div>
                        </div>
                        ...
                        <>
                            ...
                            <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-200/90 py-2 z-50">
                                <div className="px-4 py-2.5 border-b border-slate-100">
                                    ...
                                    <p className="text-[11px] text-slate-500 font-medium truncate">john@company.com</p>
                                    <span className="inline-block mt-1 bg-brand-50 text-brand-700 text-[10px] font-bold px-2 py-0.5 rounded-full">Admin Privileges</span>
                                </div>
